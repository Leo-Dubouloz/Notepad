...
namespace Notepad
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            var menuStrip = new MainMenuStrip(); // Création d'un objet de type MainMenuStrip
            MainTabControl = new MainTabControl();

            Controls.AddRange(new Control[] { MainTabControl, menuStrip }); // Ajout de cet objet sur le formulaire
        ...
        private async void InitializeFile()
        {
            ...
            if (Session.Files.Count == 0)
            {
                ...
                rtb.Select(); //active le contrôle de la zone de texte dès l'ouverture de l'application
